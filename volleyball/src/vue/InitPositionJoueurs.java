...
public class InitPositionJoueurs {
	...
	public static ArrayList<Joueur> positionnerJoueursNonIA(ArrayList<Joueur> joueurs) {
	...
	// positionne les joueurs de l'équipe sur le demi terrain du haut
		public static ArrayList<Joueur> positionnerJoueursIA(ArrayList<Joueur> joueurs) {
			Collections.shuffle(joueurs);
			// tous les joueurs regardent vers le Nord
			for(Joueur joueur : joueurs) {
				joueur.setDirection(0);
